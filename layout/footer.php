<footer class="text-center text-lg-start bg-body-tertiary text-muted">
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
      ...
      <div class="me-5 d-none d-lg-block">
        <span>Hubungi sosial media kami:</span>
      </div>
      <!-- Left -->
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <p>
              Kementrian Pariwisata dan Ekonomi Kreatif memiliki visi menjadikan Indonesia sebagai negara tujuan pariwisata kelas dunia. untuk itu, Kemenparekraf memiliki misi mengembangkan destinasi pariwisata kelas dunia dan melakukan pemasaran dengan berorientasi kepada wisatawan
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-reset">destinasi</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Festival</a>
            </p>
          </div>
          <!-- Grid column -->
